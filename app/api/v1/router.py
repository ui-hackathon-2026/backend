...
api_router.include_router(simulate.router, dependencies=require_auth)
api_router.include_router(formulas.router, dependencies=require_auth)
api_router.include_router(compliance.router, dependencies=require_auth)
...
api_router.include_router(optimize.router, dependencies=require_auth)
...
api_router.include_router(nsga.router, dependencies=require_auth)
